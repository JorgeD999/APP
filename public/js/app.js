...
// if( navigator.share){
//     console.log('Navegator lo soporta');
// } else{
//     console.log('Navegator no lo soporta');
// }
...
timeline.on('click', 'li', function(){
    ...
    if(tipo === 'mapa'){
        shareOpst.text = 'Mapa';
        shareOpst.url = `https://www.google.com/maps/@${lat},${lng},15z`;
    }    

    navigator.share(shareOpst)
